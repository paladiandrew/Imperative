...
<div className="communities-hero">
  ...
  />
      ...
      <div className="communities-mission">
        <p>Сообщество members — это дополнительные возможности для его участников, лояльность и поддержка Клуба. Для тех, кто готов делиться опытом и объединяться с другими. Мы собираем вместе людей с похожими ценностями и позицией. Нам важно поддерживать атмосферу открытости и внимания друг к другу. Поэтому вступить в сообщество возможно только по приглашению Клуба и рекомендации members.</p>
      </div>
